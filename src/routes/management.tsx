...
import { BellRing, BookOpenCheck, CalendarDays, Calculator, Crown, FileClock, GraduationCap, Settings, Sparkles, Table2, Users } from "lucide-react";
...
const items=[
 ...
 {to:'/notifications',title:'Bildirim Ayarları',desc:'Web push / FCM cihaz kaydı',icon:BellRing},
