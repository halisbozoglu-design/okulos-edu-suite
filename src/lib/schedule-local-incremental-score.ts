...
export class IncrementalScheduleScore {
 ...
 score(baseHard:number,_unplaced:number):LocalScore{const r=this.relationTotal(),studentHard=this.studentConflictMode==="HARD"?this.student:0,studentMedium=this.studentConflictMode==="MEDIUM"?this.student:0;return{hard:baseHard+r.hard+studentHard,medium:r.medium+studentMedium,soft:this.gaps*8+this.late*2+r.soft}}
