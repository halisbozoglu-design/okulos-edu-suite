...
grant insert, update, delete on public.course_catalog, public.curriculum_templates, public.curriculum_template_courses,
  public.class_course_requirements, public.teacher_course_assignments to authenticated;
grant all on public.course_catalog, public.curriculum_templates, public.curriculum_template_courses,
  public.class_course_requirements, public.teacher_course_assignments to service_role;
...
$$;
revoke all on function public.refresh_class_curriculum_status(uuid) from public;
grant execute on function public.refresh_class_curriculum_status(uuid) to authenticated;
