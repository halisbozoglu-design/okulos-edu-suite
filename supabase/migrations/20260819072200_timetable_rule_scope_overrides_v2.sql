-- Scoped scheduling-rule hierarchy:
-- teacher-assignment override > class-course requirement override > global course rule.
-- Block patterns are templates and are normalized to the actual assignment hours
-- (e.g. 2+2 template => 5 hours: 2+2+1, 3 hours: 2+1).
