-- Remove early RLS policies that treated every `manager` role as permanently privileged.
-- In delegated mode, managers must pass the central permission engine.
...
-- Explicit operational read grants (RLS above remains authoritative).
