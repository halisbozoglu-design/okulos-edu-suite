-- Safe personnel delegation. Super-admin-only identity/bootstrap operations remain isolated.
...
-- Delegated personnel managers can read the assignment-area catalog but cannot mutate it unless separately authorized.
