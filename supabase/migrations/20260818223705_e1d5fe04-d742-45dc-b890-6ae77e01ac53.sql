...
grant all on public.duty_rotation, public.vice_principals, public.teacher_duty_assignments, public.teacher_schedule, public.crisis_reports, public.absence_lessons, public.substitute_assignments, public.fcm_tokens to service_role;
