...
grant select, insert, update, delete on public.legislation_library to authenticated;
grant all on public.legislation_library to service_role;
grant select, insert, update, delete on public.legislation_shares to authenticated;
grant all on public.legislation_shares to service_role;
...
grant select on public.personnel_import_payloads to authenticated;
grant all on public.personnel_import_payloads to service_role;
grant select, insert, update, delete on public.personnel_field_catalog to authenticated;
grant all on public.personnel_field_catalog to service_role;
...
revoke all on function public.set_personnel_field_rule(text,boolean,text[]) from public, anon;
grant execute on function public.set_personnel_field_rule(text,boolean,text[]) to authenticated, service_role;