-- Explicit SQL privileges for delegated module operations. RLS remains the authorization boundary.
...
-- Duty notes/locks are also part of delegated duty management.
...
-- Read access needed by delegated managers for operational screens.
