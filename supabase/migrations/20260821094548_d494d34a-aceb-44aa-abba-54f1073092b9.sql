...
values
 ('774380','physical_education_edge_slots','Beden Eğitimi: Pazartesi 1. ders + Cuma son ders','placement','hard',0,'{"monday_first":true,"friday_last":true,"subject":"beden"}'::jsonb,true,now()),
 ('774380','music_edge_slots','Müzik: Pazartesi 1. ders + Cuma son ders','placement','hard',0,'{"monday_first":true,"friday_last":true,"subject":"muzik"}'::jsonb,true,now())
