...
grant all on public.schedule_optimization_profiles,public.schedule_optimization_settings,public.schedule_rule_modes,
  public.course_pedagogy_profiles,public.schedule_workshop_policies,public.schedule_duty_optimization,
  public.schedule_repair_audit,public.schedule_scenario_explanations to service_role;
