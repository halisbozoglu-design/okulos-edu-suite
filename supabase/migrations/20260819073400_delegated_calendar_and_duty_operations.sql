-- Calendar/settings and daily duty operations join the central delegated permission engine.

-- Academic calendar writes.
...
-- Daily duty operational logs and notes.
...
-- Delegated duty users need to read the daily book data assembled from absence/substitution sources.
...
-- Public daily-book gateway: only duty.view/manage/generate/lock holders may read the consolidated operational book.
