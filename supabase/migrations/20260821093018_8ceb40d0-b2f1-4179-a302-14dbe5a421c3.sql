...
grant select on public.personnel_private_details to authenticated;
grant all on public.personnel_private_details to service_role;
grant select on public.institution_principals to authenticated;
grant all on public.institution_principals to service_role;
grant select, insert, update, delete on public.personnel_field_overrides to authenticated;
grant all on public.personnel_field_overrides to service_role;
...
revoke all on function public.can_manage_personnel_private_data() from public, anon;
grant execute on function public.can_manage_personnel_private_data() to authenticated, service_role;
...
$$;
revoke all on function public.can_manage_institution_personnel(text) from public, anon;
grant execute on function public.can_manage_institution_personnel(text) to authenticated, service_role;
...
drop policy if exists personnel_registry_principal_read on public.personnel_registry;
drop policy if exists personnel_registry_principal_manage on public.personnel_registry;
...
drop policy if exists personnel_private_principal_read on public.personnel_private_details;
...
drop policy if exists institution_principals_self_read on public.institution_principals;
...
drop policy if exists personnel_field_overrides_principal_read on public.personnel_field_overrides;
...
drop policy if exists personnel_field_overrides_principal_manage on public.personnel_field_overrides;
...
revoke all on function public.set_personnel_field_override(text,boolean,text[]) from public, anon;
grant execute on function public.set_personnel_field_override(text,boolean,text[]) to authenticated, service_role;
...
$$;
revoke all on function public.get_personnel_field_settings() from public, anon;
grant execute on function public.get_personnel_field_settings() to authenticated, service_role;
...
revoke all on function public.get_personnel_module_fields(uuid,text) from public, anon;
grant execute on function public.get_personnel_module_fields(uuid,text) to authenticated, service_role;
...
revoke all on function public.import_personnel_registry(text,jsonb) from public, anon;
grant execute on function public.import_personnel_registry(text,jsonb) to authenticated, service_role;
...
grant select on public.profile_role_tags to authenticated;
grant all on public.profile_role_tags to service_role;
...
$$;
revoke all on function public.get_my_role_tags() from public, anon;
grant execute on function public.get_my_role_tags() to authenticated, service_role;