...
drop function if exists public.suggest_substitutes_for_day(date);
...
drop function if exists public.assign_substitutes_for_day(date);
...
drop function if exists public.super_admin_tenant_key_audit();
