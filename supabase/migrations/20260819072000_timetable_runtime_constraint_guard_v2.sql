-- Full runtime hard-constraint guard for manual/import/restore working-schedule mutations.
-- Also keeps semantic display fields (classroom/subgroup names) synchronized with their IDs.
...
begin
  ...
  -- Canonical subgroup fields: IDs are authoritative, text keys are derived.
  ...
  -- Canonical classroom fields and physical-room hard rules.
  ...
  -- Student-level collision guard for parallel subgroups.
