...
- Gıda Teknolojisi: grade 9 = 3 profiles/45 rows; grade 10 = 3 profiles/48 rows; grade 11 = 3 profiles/30 rows; grade 12 now parsed from `gida_12.pdf` as AMP 10 common + 24 enterprise + 7 elective-vocational + 4 elective = 45 and ATP 10 common + 31 academic support + 4 elective = 45.
- İnşaat Teknolojisi: grade 9 = 6 profiles/90 rows using 2026 Yapı Teknolojisi + Yapı Teknik Ressamlığı. Living transition retains six older branches. Grade 10 = 18 profiles (2024-41), grade 11 = 18 profiles (2024-41), grade 12 = 12 profiles (2023-40). Grade-12 common/enterprise rows seeded; ATP academic-support remains package-based. Exact `insaat_10/11/12.pdf` URLs pinned.
- Sağlık Hizmetleri: grade 9 = 6 profiles/96 rows using 2026 Diş Protez Teknisyenliği + Sağlık Bakım Teknisyenliği. Living transition retains Ebe Yardımcılığı, Hemşire Yardımcılığı, Sağlık Bakım Teknisyenliği. Grade 10 = 9 profiles plus real 17-row core for each branch/variant; grade 11 = 9 profiles; grade 12 = 6 profiles with AMP enterprise vs ATP academic support. Exact `saglik_10/11/12.pdf` URLs pinned.
...
- Gıda grade 12, İnşaat 10-12 and Sağlık 10-12 were added without a new migration; existing schema/batch design was sufficient.
...
## Next
1. Complete row-level 10-11 details for İnşaat and Sağlık (profiles already complete).
2. Parse academic-support package tables and branch-scoped elective-vocational eligibility.
